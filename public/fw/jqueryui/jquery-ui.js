...
(function(factory) {
    ...
    */
    ...
    function Datepicker() {
        ...
        this.dpDiv = datepicker_bindHover($("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all corregido_datepicker_css'></div>"));
    }
